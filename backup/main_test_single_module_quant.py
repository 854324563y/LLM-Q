...
from quantize.abq_llm_test_single_module_quant import abqllm
...
def main():
    ...
    parser.add_argument("--quant_module", type=str, default="", choices=["down_proj", "up_proj", "gate_proj", "o_proj", "q_proj", "k_proj", "v_proj", "out_proj"])
    ...
    print(args.quant_module, results)
