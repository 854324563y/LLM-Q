...
from quantize.abq_llm_attnmap import abqllm
...
if __name__ == "__main__":
    print(sys.argv)
    main()
    # python main_attnmap.py --model /workspace/volume/inference-soft-data/AE/llm/models/Llama-2-7b-hf --epochs 1 --output_dir ./log-attnmap/Llama-2-7b-hf --wbits 16 --abits 16 --nsamples 1 --epochs 1
