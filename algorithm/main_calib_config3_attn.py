...
from quantize.abq_llm_calib_config3_attn import abqllm
...
def main():
    ...
    parser.add_argument("--blocks_pkl", type=str, default=None, help="Path to the blocks_pkl file")
    ...
    if args.blocks_pkl is None:
        raise ValueError("blocks_pkl must be provided")
...
# main_calib_config3.py
# args添加了--blocks_pkl，一次校准blocks内的所有参数
