...
from quantize.abq_llm_calibration_a2 import abqllm
...
def main():
    ...
    parser.add_argument("--rank", type=int, default=1, help="rank for compensation calibration")
    parser.add_argument("--loss_type", type=str, default="all", 
                        choices=["mse", "cos", "kl", "all", "mse+cos", "mse+kl", "cos+kl"], 
                        help="loss function type for calibration")
