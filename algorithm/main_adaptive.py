...
from quantize.adaptive.block_wise_quant_config_search import search_quant_config, load_search_quant_config
...
def main():
    ...
    if args.reload:
        load_search_quant_config(lm, None, args, dataloader, logger)
    else:
        search_quant_config(lm, None, args, dataloader, logger)
...
if __name__ == "__main__":
    print(sys.argv)
    main()
    # cp main_quant_config.py main_adaptive.py
    ...
    # python main_adaptive.py --model /workspace/volume/inference-soft-data/AE/llm/models/Llama-2-7b-chat-hf --output_dir ./log/Llama-2-7b-chat-hf-mpq-paral --nsamples 128 2>&1 | tee log/Llama-2-7b-chat-hf-mpq-paral/log.txt